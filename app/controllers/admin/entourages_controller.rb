module Admin
  class EntouragesController < Admin::BaseController
    ...
    def index_params
      params.permit([:search, :moderator_id, q: [:entourage_type_eq, :status_eq, :display_category_eq, :country_eq, :postal_code_start, :pin_eq, :group_type_eq, :moderation_action_outcome_blank, postal_code_start_any: [], postal_code_not_start_all: []]]).to_h
    end
