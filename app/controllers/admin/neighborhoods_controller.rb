module Admin
  class NeighborhoodsController < Admin::BaseController
    ...
    def neighborhood_params
      params.require(:neighborhood).permit(:status, :public, :reserved_female, :name, :description, :interest_list, :neighborhood_image_id, :google_place_id, :user_id, :change_ownership_message, interests: [])
    end
