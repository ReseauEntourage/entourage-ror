module Admin
  class UsersController < Admin::BaseController
    ...
    def user_params
      params.require(:user).permit(:first_name, :last_name, :email, :sms_code, :phone, :travel_distance, :organization_id, :use_suggestions, :about, :accepts_emails, :targeting_profile, :partner_id, :admin, :moderator)
    end
