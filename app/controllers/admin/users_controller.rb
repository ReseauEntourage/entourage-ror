module Admin
  class UsersController < Admin::BaseController
    ...
    def user_params
      params.require(:user).permit(:first_name, :last_name, :email, :sms_code, :phone, :organization_id, :use_suggestions, :about, :accepts_emails, :targeting_profile, :partner_id, :admin, :moderator, :interest_list, interests: [])
    end
