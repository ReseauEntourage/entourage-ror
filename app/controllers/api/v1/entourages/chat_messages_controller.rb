    ...
    module Entourages
      ...
      class ChatMessagesController < Api::V1::BaseController
        ...
        def index
          ...
          messages = @entourage.chat_messages.includes(user: {default_user_partners: :partner}).ordered.before(before).limit(25)
        ...
        def set_entourage_or_handle_conversation_uuid
          ...
          @entourage = Entourage.visible.find_by(uuid_v2: hash_uuid)
          if @entourage.nil?
