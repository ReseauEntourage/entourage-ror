  ...
  module V1
    class EntouragesController < Api::V1::BaseController
      ...
      def entourage_params
        ...
        params.require(:entourage).permit(:group_type, {location: [:longitude, :latitude]}, :title, :entourage_type, :display_category, :status, :description, :category, :invite_followers, {outcome: [:success]}, {metadata: metadata_keys}, :recipient_consent_obtained)
      end
