  ...
  module V1
    module Neighborhoods
      ...
      class ChatMessagesController < Api::V1::BaseController
        ...
        def index
          messages = @neighborhood.parent_chat_messages.includes(:translation, :user, :chat_message_reactions, :user_reactions, :user_survey_responses).ordered.page(page).per(per)
