  ...
  module V1
    module Neighborhoods
      ...
      class OutingsController < Api::V1::BaseController
        ...
        def index
          render json: @neighborhood.outings_with_admin_online.active.future_or_past_today.page(page).per(per), root: :outings, each_serializer: ::V1::OutingSerializer, scope: {
            user: current_user
          }
        end
