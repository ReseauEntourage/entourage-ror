    ...
    class NotificationPermissionsController < Api::V1::BaseController
      ...
      def create
        ...
        if @notification_permission.save
          ...
          render_error(code: Api::V1::ErrorCodes::VALIDATION_ERROR, legacy: { message: 'Could not create notification_permission', reasons: @notification_permission.errors.full_messages }, status: :unprocessable_entity)
        end
      end
