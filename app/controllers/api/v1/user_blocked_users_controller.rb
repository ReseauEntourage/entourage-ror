    ...
    class UserBlockedUsersController < Api::V1::BaseController
      ...
      def create_one
        ...
        if user_blocked_user.save
          ...
          render_error(code: Api::V1::ErrorCodes::VALIDATION_ERROR, legacy: { message: 'Could not block user_blocked_user', reasons: user_blocked_user.errors.full_messages }, status: :unprocessable_entity)
        end
      end
      ...
      def create_many
        if current_user.update_attribute(:blocked_user_ids, blocked_user_ids)
          ...
          render_error(code: Api::V1::ErrorCodes::VALIDATION_ERROR, legacy: { message: 'Could not block user_blocked_user', reasons: current_user.errors.full_messages }, status: :unprocessable_entity)
        end
      end
      ...
      def destroy_one
        ...
        if user_blocked_user.delete
          ...
          render_error(code: Api::V1::ErrorCodes::VALIDATION_ERROR, legacy: { message: 'Could not unblock user_blocked_user', reasons: user_blocked_user.errors.full_messages }, status: :unprocessable_entity)
        end
      end
      ...
      def destroy_many
        ...
        if user_blocked_users.delete_all
          ...
          render_error(code: Api::V1::ErrorCodes::VALIDATION_ERROR, legacy: { message: 'Could not unblock user_blocked_user', reasons: user_blocked_users.errors.full_messages }, status: :unprocessable_entity)
        end
      end
