...
module Api
  module V1
    class UsersController < Api::V1::BaseController
      ...
      private
      def user_params
        @user_params ||= params.require(:user).permit(:first_name, :last_name, :email, :sms_code, :password, :secret, :auth_token, :phone, :current_phone, :requested_phone, :avatar_key, :newsletter_subscription, :about, :goal, :birthdate, :travel_distance, :gender, :partner_id, :discovery_source, :company, :event, :willing_to_engage_locally, :sf_entreprise_id, :sf_campaign_id, :orientation, :other_interest, :interest_list, :involvement_list, :concerns_list, :interests, :involvements, :concerns, interests: [], involvements: [], concerns: [], availability: {})
      end
