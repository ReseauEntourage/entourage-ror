...
module Api
  module V1
    class UsersController < Api::V1::BaseController
      ...
      private
      def user_params
        @user_params ||= params.require(:user).permit(:first_name, :last_name, :email, :sms_code, :password, :secret, :auth_token, :phone, :current_phone, :requested_phone, :avatar_key, :about, :goal, :travel_distance, :birthday, :other_interest, :interest_list, interests: [])
      end

      def update_params
        @update_params ||= params.require(:user).permit(:first_name, :last_name, :email, :sms_code, :password, :secret, :auth_token, :current_phone, :requested_phone, :avatar_key, :about, :goal, :travel_distance, :birthday, :other_interest, :interest_list, :interests, interests: [])
      end
