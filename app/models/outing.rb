class Outing < Entourage
  ...
  def unsubscribed_participants_offer_help
    return 0 unless metadata[:unsubscribed_participants_offer_help].present?

    metadata[:unsubscribed_participants_offer_help].to_i
  end

  def unsubscribed_participants_offer_help= integer
    metadata[:unsubscribed_participants_offer_help] = integer
  end

  def unsubscribed_participants_ask_for_help
    return 0 unless metadata[:unsubscribed_participants_ask_for_help].present?

    metadata[:unsubscribed_participants_ask_for_help].to_i
  end
