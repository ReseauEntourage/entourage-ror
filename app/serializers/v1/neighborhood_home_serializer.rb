module V1
  class NeighborhoodHomeSerializer < ActiveModel::Serializer
    ...
    def outings
      object.outings_with_admin_online(scope: :future_outings).active.future_or_ongoing.default_order.limit(OUTINGS_LIMIT)
    end
    ...
    def ongoing_outings
      object.outings_with_admin_online(scope: :ongoing_outings).active.future_or_ongoing.default_order.limit(OUTINGS_LIMIT)
    end
