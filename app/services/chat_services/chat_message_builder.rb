  ...
  class ChatMessageBuilder
    ...
    def create
      ...
      if success
        ...
        join_request.set_chat_messages_as_read_from(message.created_at) unless [Neighborhood, Outing, NeighborhoodMessageBroadcast, Smalltalk].include?(joinable.class)
