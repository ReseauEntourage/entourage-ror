...
module EntourageBack
  class Application < Rails::Application
    ...
    config.active_record.observers = [:entourage_denorm_observer, :user_block_observer, :join_request_observer, :push_notification_trigger_observer, :translation_observer]
