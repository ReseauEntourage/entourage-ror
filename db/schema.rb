...
ActiveRecord::Schema[7.1].define(version: 2026_09_15_120100) do
  ...
  create_table "chat_messages", id: :serial, force: :cascade do |t|
    ...
    t.index ["messageable_type", "messageable_id", "created_at"], name: "index_chat_messages_on_messageable_and_created_at"
  ...
  create_table "denorm_daily_engagements_with_type", force: :cascade do |t|
    t.date "date", null: false
    t.integer "user_id", null: false
    t.string "postal_code"
    t.string "engagement_type", default: "--", null: false
    t.index ["date", "user_id", "postal_code", "engagement_type"], name: "index_denorm_daily_engagements_on_all_fields", unique: true
    t.index ["date", "user_id"], name: "index_denorm_daily_engagements_on_date_user"
  end
  ...
  create_table "join_requests", id: :serial, force: :cascade do |t|
    ...
    t.string "salesforce_id"
    t.datetime "participate_at", precision: nil
    t.index ["joinable_type", "joinable_id"], name: "index_join_requests_on_joinable_type_and_joinable_id"
    t.index ["participate_at"], name: "index_join_requests_on_participate_at"
  ...
  create_table "neighborhoods", force: :cascade do |t|
    ...
    t.integer "number_of_root_chat_messages", default: 0
    t.boolean "reserved_female", default: false, null: false
  ...
  create_table "openai_requests", force: :cascade do |t|
    ...
    t.string "status"
    t.datetime "run_starts_at", precision: nil
    t.datetime "run_ends_at", precision: nil
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "partners", id: :serial, force: :cascade do |t|
    ...
    t.string "image_url"
    t.index ["searchable_text"], name: "index_partners_on_searchable_text_trgm", opclass: :gin_trgm_ops, using: :gin
  end
  ...
  create_table "user_segment_history", force: :cascade do |t|
    t.integer "user_id", null: false
    ...
    t.index ["user_id", "valid_from"], name: "index_user_segment_history_on_user_id_and_valid_from", unique: true
    t.index ["user_id"], name: "index_user_segment_history_on_user_id_where_open", unique: true, where: "(valid_to IS NULL)"
  end
  ...
  create_table "user_segments", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_user_segments_on_user_id", unique: true
  end
