...
RSpec.describe Api::V1::EncountersController, :type => :controller do
  ...
  describe 'GET index' do
    ...
    context "deleted encounter" do
      let!(:encounter) do
        encounter = FactoryBot.create(:encounter, tour: tour)
      ...
      it "renders encounter" do
        ...
        expect(resp).to eq({
          "encounter" => {
            ...
            "latitude" => 48.870424,
            "longitude" => 2.30682,
            "user_id" => encounter.tour.user.id,
            "user_name" => "John",
            "street_person_name" => "Toto",
            "message" => "Toto fait du velo.",
            "voice_message" => "https://www.google.com"
  ...
  describe "PUT update" do
    ...
    before { put :update, params: {
      ...
      encounter: {
        street_person_name: "foo1",
        message: "foobar1",
        voice_message: "http://foo.bar1",
        longitude: 43.423, latitude: 1.674
      },
      token: user.token
    } }
