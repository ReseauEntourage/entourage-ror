    ...
    context "signed in" do
      ...
      describe "send push notif" do
        it "sends notif to everyone accepted except message sender" do
          ...
          expect_any_instance_of(PushNotificationService).to receive(:send_notification).with(nil, 'John D. - Foobar', 'foobaz', [join_request2.user], "solicitation", entourage.id, {
