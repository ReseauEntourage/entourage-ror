...
describe Api::V1::Outings::ChatMessages::ReactionsController do
  ...
  describe 'details' do
    ...
    context 'not signed in' do
      before { get :details, params: { id: user_reaction_1.reaction_id, outing_id: outing.to_param, chat_message_id: chat_message.id } }
  ...
  describe 'users' do
    ...
    context 'not signed in' do
      before { get :users, params: { outing_id: outing.to_param, chat_message_id: chat_message.id } }
