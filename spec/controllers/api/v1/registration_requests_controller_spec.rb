  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      ...
      it { expect(JSON.parse(response.body)).to eq({
        "errors" => {
          "organization" => [
            "Nom doit être rempli(e)",
            "Adresse doit être rempli(e)"
          ],
          "user" => [
            "Téléphone doit être rempli(e)",
            "Téléphone devrait être au format +33... ou 06...",
            "Prénom doit être rempli(e)",
            "Nom doit être rempli(e)",
            "Email doit être rempli(e)",
            "Association de maraude n'est pas valide"
          ]
        }
      }) }
    end
