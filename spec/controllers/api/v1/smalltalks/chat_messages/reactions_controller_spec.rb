...
describe Api::V1::Smalltalks::ChatMessages::ReactionsController do
  let(:user) { create(:pro_user) }
  let(:smalltalk) { create :smalltalk }
  let(:chat_message) { create(:chat_message, messageable: smalltalk) }
  ...
  describe 'index' do
    ...
    context "not signed in" do
      before { get :index, params: { smalltalk_id: smalltalk.to_param, chat_message_id: chat_message.id } }

      it { expect(response.status).to eq(401) }
    end

    context "signed in" do
      before { get :index, params: { smalltalk_id: smalltalk.to_param, token: user.token, chat_message_id: chat_message.id } }
  ...
  describe 'details' do
    ...
    context "not signed in" do
      before { get :details, params: { id: user_reaction_1.reaction_id, smalltalk_id: smalltalk.to_param, chat_message_id: chat_message.id } }

      it { expect(response.status).to eq(401) }
    end

    context "signed in" do
      before { get :details, params: { id: user_reaction_1.reaction_id, smalltalk_id: smalltalk.to_param, token: user.token, chat_message_id: chat_message.id } }
  ...
  describe 'users' do
    ...
    context "not signed in" do
      before { get :users, params: { smalltalk_id: smalltalk.to_param, chat_message_id: chat_message.id } }

      it { expect(response.status).to eq(401) }
    end

    context "signed in" do
      before { get :users, params: { smalltalk_id: smalltalk.to_param, token: user.token, chat_message_id: chat_message.id } }
  ...
  describe 'create' do
    ...
    let(:request) { post :create, params: { smalltalk_id: smalltalk.to_param, chat_message_id: chat_message.id, token: user.token, reaction_id: reaction.id } }
  ...
  describe 'destroy' do
    ...
    let(:request) { delete :destroy, params: { smalltalk_id: smalltalk.to_param, chat_message_id: chat_message.id, token: user.token } }
