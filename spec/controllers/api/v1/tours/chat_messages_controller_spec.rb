    ...
    context "signed in" do
      ...
      describe "send push notif" do
        it "sends notif to everyone accaepted except message sender" do
          ...
          expect_any_instance_of(PushNotificationService).to receive(:send_notification).with(user.full_name, 'Nouveau message', 'foobar', [tour_user2.user], {:extra=>{:tour_id=>tour.id}})
