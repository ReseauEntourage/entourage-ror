...
RSpec.describe Api::V1::UsersController, :type => :controller do
  ...
  describe 'PATCH update' do
    ...
    context 'authentication is OK' do
      ...
      context 'discoery_source' do
        before { patch 'update', params: { token: user.token, user: { discoery_source: 'word_of_mouth' } } }
        it { expect(user.reload.discoery_source).to eq('word_of_mouth') }
      end
