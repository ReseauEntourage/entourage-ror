        ...
        it 'renders user' do
          expect(result).to eq({
            'user' => {
              ...
              'goal' => nil,
              'phone' => user.phone,
              'unread_count' => 0, "badges" => [{ "tag" => "bienvenue", "active" => false, "awarded_at" => nil, "current" => 0, "target" => 1 }, { "tag" => "premier_contact", "active" => false, "awarded_at" => nil, "current" => 0, "target" => 1 }, { "tag" => "moteur_rencontres", "active" => false, "awarded_at" => nil, "current" => 0, "target" => 3 }, { "tag" => "fidele_papotages", "active" => false, "awarded_at" => nil, "current" => 0, "target" => 6 }, { "tag" => "voix_presente", "active" => false, "awarded_at" => nil, "current" => 0, "target" => 3 }], "badges" => [{ "tag" => "bienvenue", "active" => false, "awarded_at" => nil, "current" => 0, "target" => 1 }, { "tag" => "premier_contact", "active" => false, "awarded_at" => nil, "current" => 0, "target" => 1 }, { "tag" => "moteur_rencontres", "active" => false, "awarded_at" => nil, "current" => 0, "target" => 3 }, { "tag" => "fidele_papotages", "active" => false, "awarded_at" => nil, "current" => 0, "target" => 6 }, { "tag" => "voix_presente", "active" => false, "awarded_at" => nil, "current" => 0, "target" => 3 }], "badges" => [{ "tag" => "bienvenue", "active" => false, "awarded_at" => nil, "current" => 0, "target" => 1 }, { "tag" => "premier_contact", "active" => false, "awarded_at" => nil, "current" => 0, "target" => 1 }, { "tag" => "moteur_rencontres", "active" => false, "awarded_at" => nil, "current" => 0, "target" => 3 }, { "tag" => "fidele_papotages", "active" => false, "awarded_at" => nil, "current" => 0, "target" => 6 }, { "tag" => "voix_presente", "active" => false, "awarded_at" => nil, "current" => 0, "target" => 3 }], "badges" => [{ "tag" => "bienvenue", "active" => false, "awarded_at" => nil, "current" => 0, "target" => 1 }, { "tag" => "premier_contact", "active" => false, "awarded_at" => nil, "current" => 0, "target" => 1 }, { "tag" => "moteur_rencontres", "active" => false, "awarded_at" => nil, "current" => 0, "target" => 3 }, { "tag" => "fidele_papotages", "active" => false, "awarded_at" => nil, "current" => 0, "target" => 6 }, { "tag" => "voix_presente", "active" => false, "awarded_at" => nil, "current" => 0, "target" => 3 }],
              'birthday' => nil,
      ...
      context 'get your own profile' do
        ...
        it { expect(JSON.parse(response.body)).to eq({
          'user' => {
            ...
            'birthday' => nil,
            'birthday_today' => false,
            'unread_count' => 0, "badges" => [{ "tag" => "bienvenue", "active" => false, "awarded_at" => nil, "current" => 0, "target" => 1 }, { "tag" => "premier_contact", "active" => false, "awarded_at" => nil, "current" => 0, "target" => 1 }, { "tag" => "moteur_rencontres", "active" => false, "awarded_at" => nil, "current" => 0, "target" => 3 }, { "tag" => "fidele_papotages", "active" => false, "awarded_at" => nil, "current" => 0, "target" => 6 }, { "tag" => "voix_presente", "active" => false, "awarded_at" => nil, "current" => 0, "target" => 3 }],
            'interests' => [],
            'involvements' => [],
            'orientations' => [],
            'gender' => nil,
