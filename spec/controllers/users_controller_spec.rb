  ...
  describe '#send_sms' do
    ...
    context 'the user exists' do
      ...
      it "sends sms" do
        ...
        expect_any_instance_of(SmsNotificationService).to receive(:send_notification).with(target_user.phone, "Bienvenue dans le beta-test de l'application Entourage ! Votre code est 666666. Téléchargez l'application ici : http://foo.bar .")
