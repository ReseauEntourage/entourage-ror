...
RSpec.describe LoginHistory, :type => :model do
  ...
  describe "unique by hour" do
    ...
    it { expect(LoginHistory.new(user_id: 1, connected_at: DateTime.parse("10/10/2010 21:45:00")).save).to be false }
    it { expect(LoginHistory.new(user_id: 2, connected_at: DateTime.parse("10/10/2010 21:45:00")).save).to be true }
    it { expect(LoginHistory.new(user_id: 1, connected_at: DateTime.parse("10/10/2010 21:01:00")).save).to be false }
