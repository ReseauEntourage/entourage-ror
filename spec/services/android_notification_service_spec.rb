...
describe AndroidNotificationService do
  ...
  describe 'FCM updates' do
    ...
    context 'update existing id by canonical id received from FCM' do
      let!(:user_application) { FactoryGirl.create(:user_application, user: user, push_token: "old_token", device_family: UserApplication::ANDROID, version: "1.0") }
    ...
    context 'unregistered id received from FCM' do
      let!(:user_application) { FactoryGirl.create(:user_application, user: user, push_token: "token", device_family: UserApplication::ANDROID, version: "1.0") }
      let!(:user_application1) { FactoryGirl.create(:user_application, user: user, push_token: "token2", device_family: UserApplication::ANDROID, version: "1.1") }
      let!(:user_application2) { FactoryGirl.create(:user_application, user: user, push_token: "token3", device_family: UserApplication::ANDROID, version: "1.2") }
    ...
    context 'unregistering unkown id received from FCM' do
      let!(:user_application) { FactoryGirl.create(:user_application, user: user, push_token: "token", device_family: UserApplication::ANDROID, version: "1.0") }
      let!(:user_application2) { FactoryGirl.create(:user_application, user: user, push_token: "token2", device_family: UserApplication::ANDROID, version: "1.1") }
      let!(:user_application3) { FactoryGirl.create(:user_application, user: user, push_token: "token3", device_family: UserApplication::ANDROID, version: "1.2") }
