...
describe Api::ApplicationKey do
  describe 'authorised?' do
    ...
    context 'known api key' do
      ...
      it { expect(application_key.key_infos).to eq( {version: '1.0', device: 'rspec', device_family: UserApplication::ANDROID, community: 'entourage', hmac_secret: 'rspec_hmac_secret'}) }
    end
